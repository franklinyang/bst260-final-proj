...
`app.R` contains a tool that will allow you to compare states. Using this tool, it is easy to dig into the relationship between  outcome measures and costs. 
