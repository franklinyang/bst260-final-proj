...
#Join example
res <- dbFetch(dbSendQuery(con, "SELECT a.*, b.Avg_Spending_Per_Episode_Hospital FROM hospital_info a left join spending_by_claim b on a.facility_id = b.facility_id"))
